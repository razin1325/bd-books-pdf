...
export default function Header() {
  ...
  return (
    <header className="w-full relative z-50">
      ...
      {/* Top Banner Notice — Scrolls away naturally */}
      ...
      {/* News Ticker Marquee — Scrolls away naturally */}
      ...
      {/* Main Navigation Bar — Pure CSS Sticky Top 0 (Zero Glitch / Perfect Smooth Scroll) */}
      <div className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-emerald-100 shadow-sm transition-shadow">
